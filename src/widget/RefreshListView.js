...
import {ActivityIndicator, ListView, RefreshControl, StyleSheet, Text, TouchableOpacity, View} from 'react-native';
...
class RefreshListView extends PureComponent {
    static propTypes = {
        onHeaderRefresh: PropTypes.PropTypes.func,
        onFooterRefresh: PropTypes.PropTypes.func,
    };
