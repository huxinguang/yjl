...
export default class Alert extends Component {
    ...
    constructor(props) {
        ...
        global.show = this.show.bind(this);
        global.out = this.out.bind(this);
                ...
                <View style={styles.container} >
                    ...
                    <Animated.View style={[styles.tip , {transform: [{
                        translateY: this.state.offset.interpolate({
                            inputRange: [0, 1],
                            outputRange: [height, (height-aHeight - 64)]// 34
                        }),
                    }]
                    }]}>
    ...
    choose(msg) {
        ...
        if(!this.state.hide){
            this.out();
            /*根据业务需求 parent 就是parentView 调用state去修改状态刷新view*/
            this.parent && this.parent.setState({sex:msg});
        }
    }
