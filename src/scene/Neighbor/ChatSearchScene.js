...
class ChatSearchScene extends PureComponent {
    ...
    loadSearchHistory() {
        let _this = this;
        StorageUtil.selectObject(GlobalKey.CHAT_SEARCH, function (data) {
            if (data) {
    ...
    onSearchPress() {
        if (this.keyWord && this.keyWord !== '') {
            ...
            StorageUtil.storageSave(GlobalKey.CHAT_SEARCH, this.historyList);
            this.requestData();
        }
    }
...
export default ChatSearchScene;