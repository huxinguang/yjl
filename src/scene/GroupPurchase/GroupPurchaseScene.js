...
import {Image, InteractionManager, ListView, StyleSheet, View} from 'react-native';
import {Button, color, NavigationItem, RefreshListView, RefreshState, Separator, SpacingView} from '../../widget';
...
class GroupPurchaseScene extends PureComponent {
    ...
    static navigationOptions = ({navigation}) => ({
        ...
        headerRight: (
            <NavigationItem
                icon={{uri: '../../img/Public/icon_navigationItem_share@2x.png'}}
                onPress={() => {
